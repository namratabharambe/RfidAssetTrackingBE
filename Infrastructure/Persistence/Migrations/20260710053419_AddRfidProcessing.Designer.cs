...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260710053419_AddRfidProcessing")]
    partial class AddRfidProcessing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.ActiveTruckSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ActiveTruckSessions");
                });

            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.Alert", b =>
                {
                    ...
                    b.ToTable("RfidAlerts", (string)null);
                });

            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.Equipment", b =>
                {
                    b.Property<Guid>("EquipmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<DateTime?>("LastDateTimeIn")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("LastDateTimeOut")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.GateEvent", b =>
                {
                    b.Property<Guid>("GateEventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.GateEventItem", b =>
                {
                    b.Property<Guid>("GateEventItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("GateEventItemId");

                    b.HasIndex("GateEventId");

                    b.ToTable("GateEventItems");
                });

            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.MissingEquipmentCase", b =>
                {
                    b.Property<Guid>("MissingEquipmentCaseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("MissingEquipmentCaseId");

                    b.ToTable("MissingEquipmentCases");
                });

            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.MissingEquipmentCaseItem", b =>
                {
                    b.Property<Guid>("MissingEquipmentCaseItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("MissingEquipmentCaseItemId");

                    b.HasIndex("MissingEquipmentCaseId");

                    b.ToTable("MissingEquipmentCaseItems");
                });

            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.MissingEquipmentSeverity", b =>
                {
                    b.Property<int>("SeverityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MissingEquipmentSeverities");
                });

            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.MissingEquipmentStatus", b =>
                {
                    b.Property<int>("StatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MissingEquipmentStatuses");
                });

            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.RfidTag", b =>
                {
                    b.Property<Guid>("RfidTagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CustomRfidTags");
                });

            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.Truck", b =>
                {
                    b.Property<Guid>("TruckId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.TruckEquipmentAssignment", b =>
                {
                    ...
                    b.ToTable("TruckEquipmentAssignments");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Asset", b =>
                {
                    ...
                    b.Property<string>("CurrentCustodian")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.Entities.RfidScan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.Equipment", b =>
                {
                    b.HasOne("AssetTracking.Rfid.Domain.Entities.RfidTag", "RfidTag")
                        .WithMany()
            ...
            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.GateEventItem", b =>
                {
                    b.HasOne("AssetTracking.Rfid.Domain.Entities.GateEvent", null)
                        .WithMany("Items")
                        .HasForeignKey("GateEventId")
            ...
            modelBuilder.Entity("AssetTracking.Rfid.Domain.Entities.MissingEquipmentCaseItem", b =>
                {
                    b.HasOne("AssetTracking.Rfid.Domain.Entities.MissingEquipmentCase", "MissingEquipmentCase")
                        .WithMany("Items")
                        .HasForeignKey("MissingEquipmentCaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MissingEquipmentCase");
                });
